...
export const metadata: Metadata = {
  title: {
    default: "HB Realty India — Land Development & Warehousing in Nashik, Maharashtra",
  ...
  openGraph: {
    ...
    title: "HB Realty India — Land Development & Warehousing Experts in Nashik",
    description:
      "Nashik's most trusted land development company and warehousing consultant. Grade-A warehouse construction, industrial plot development, legal liaisoning, and end-to-end real estate solutions across Maharashtra.",
    images: [
      {
        url: "/logo.png",
        width: 1200,
        height: 630,
        alt: "HB Realty India — Land Development & Warehousing in Nashik",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "HB Realty India — Land Development & Warehousing in Nashik",
    description:
      "Trusted land development company and warehousing consultant in Nashik, Maharashtra. Grade-A warehouse construction, industrial plots, and real estate legal services.",
    images: ["/logo.png"],
  },
  robots: {
    index: true,
